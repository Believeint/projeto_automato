...
ALTER TABLE `Transacao` ADD CONSTRAINT `Transacao_fk0` FOREIGN KEY (`id_cliente`) REFERENCES `Cliente`(`id`);



ALTER TABLE `Arquivo_Transacao` ADD CONSTRAINT `Arquivo_Transacao_fk0` FOREIGN KEY (`id_arquivo`) REFERENCES `Arquivo`(`id`);



ALTER TABLE `Arquivo_Transacao` ADD CONSTRAINT `Arquivo_Transacao_fk1` FOREIGN KEY (`id_transacao`) REFERENCES `Transacao`(`transacao_id`);



ALTER TABLE `Arquivo_Relatorio` ADD CONSTRAINT `Arquivo_Relatorio_fk0` FOREIGN KEY (`id_arquivo`) REFERENCES `Arquivo`(`id`);



ALTER TABLE `Arquivo_Relatorio` ADD CONSTRAINT `Arquivo_Relatorio_fk1` FOREIGN KEY (`id_cliente`) REFERENCES `Cliente`(`id`);
